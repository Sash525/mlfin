...
class SMAVectorBacktester (object):
    ...
    start: str
        start date dor data retrieval
    end: str
        end date for data retrieval
    datafile: str
        path for file with data set
    ...
    optimize_parameters:
        implements a brute force optimization for thr two SMA parameters
        
    '''
    def __init__(self, symbol, SMA1, SMA2, start, end, datafile):
        self.symbol = symbol
        self.SMA1 = SMA1
        self.SMA2 = SMA2
        self.start = start
    ...
    def get_data(self):
        '''Retrivies and prepares the data        
        '''
    ...
    if __name__ == '__main__':
        smabt = SMAVectorBacktester('EURUSD', 42, 252,
                                    '2010-01-03', '2020-12-31')
        print(smabt.run_strategy())
        smabt.set_parameters(SMA1=20, SMA2=100)
        print(smabt.run_strategy())
        print(smabt.optitmize_parameters((30, 56, 4), (200, 300, 4)))
